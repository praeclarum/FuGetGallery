...
namespace FuGetGallery
{
    public static class NugetPackageSources
    {
        ...
        private static List<NugetPackageSource> GetPackageSources ()
        {
            ...
            //Console.WriteLine ("CONFFIG = " + _configuration);
            //Console.WriteLine ("CONFFIG+++ = " + _configuration.GetSection ("NugetPackageSources"));
            ...
            return new List<NugetPackageSource> {
                new NugetPackageSource(
                    ...
                    "https://azuresearch-usnc.nuget.org/query?prerelease=true&semVerLevel=2.0.0&q={0}",
                    "https://api.nuget.org/v3/registration5-gz-semver2/{0}/index.json",
                    "https://globalcdn.nuget.org/packages/{0}.{1}.nupkg")
            };
        }
    }
}
